...
import 'package:msf/core/data/dashboard/ResourceUsage.dart';
  ...
  void updateUsageData(Map<String, dynamic> data) {
    resourceUsage.update((res) {
      if (res != null) {
        ...
        res.cloudUsage =
            data['cloud_usage_percentage']?.toInt() ?? res.cloudUsage;
        res.memoryUsage =
            data['memory_usage_percentage']?.toInt() ?? res.memoryUsage;
